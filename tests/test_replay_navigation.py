...
assert.deepEqual(scripts,['connections.js','comparison.js','app.js','today_progress.js','workbench.js','accounts.js','review.js','software_updates.js','update_exit.js','method_transfer.js']);
