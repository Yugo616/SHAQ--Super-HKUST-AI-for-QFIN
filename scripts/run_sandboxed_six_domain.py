...
from shaq_daily_oracle import run_sandboxed_six_domain  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run six blinded domains in the attested Codex sandbox")
    ...
    result = run_sandboxed_six_domain(
        run_id=args.run_id,
